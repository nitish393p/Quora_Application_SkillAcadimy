...
import NitishImg from '../assets/nitish.jpg'
      ...
      <>
        ...
        <div className="p-4">
          <div className="flex items-center space-x-2 mb-3">
            <img className="rounded-full bg-gray-300 h-6 w-6" src={NitishImg} alt="N" />
    ...
    {tab === "Create Post" && (
      <>
        <div className="flex items-center px-4 py-3 space-x-3">
          <img
            src={NitishImg} // Replace with actual profile image
            alt="Profile"
            className="rounded-full w-10 h-10"
          />
          <div>
            <h4 className="font-semibold text-gray-800">Nitish Patil</h4>
